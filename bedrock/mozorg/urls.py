...
urlpatterns = patterns('',
    ...
    page('contact/spaces', 'mozorg/contact/spaces-landing.html'),
    ...
    page('contact/spaces/paris', 'mozorg/contact/paris.html'),
    page('contact/spaces/portland', 'mozorg/contact/portland.html'),
    page('contact/spaces/san-francisco', 'mozorg/contact/san-francisco.html'),
    page('contact/spaces/taipei', 'mozorg/contact/taipei.html'),
    page('contact/spaces/tokyo', 'mozorg/contact/tokyo.html'),
    page('contact/spaces/toronto', 'mozorg/contact/toronto.html'),
    page('contact/spaces/vancouver', 'mozorg/contact/vancouver.html'),

    page('contact/community', 'mozorg/contact/community-landing.html'),
    page('contact/community/north-america', 'mozorg/contact/north-america.html'),
    page('contact/community/latin-america', 'mozorg/contact/latin-america.html'),
    page('contact/community/europe', 'mozorg/contact/europe.html'),
    page('contact/community/asia-south-pacific', 'mozorg/contact/asia-south-pacific.html'),
    page('contact/community/antarctica', 'mozorg/contact/antarctica.html'),
    page('contact/community/africa-middle-east', 'mozorg/contact/africa-middle-east.html'),
